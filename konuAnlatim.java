...
public class konuAnlatim {
    ...
    3-LinkedListlerde her zaman en başta "head" vardır. "Head" sadece adres bölümünden oluşur. "Head için data bölumü yoktur.
...
*/
    ...
    4- Üç farklı map vardır.
        a) HashMap : En çok kullanılan ve en hızlıdır. Hızlı olabilmek için sıralamayı rastgele yapar.
   ...
   **********önemli******* 1- HashMap ve TreeMap synchorized ve thread-safe değildir. Map ler arasında synchorized ve thread-safe olan
    bir map e ihtiyaç vardır. bu yüzden HashTable oluştrulmuştur
